...
enum HTTPStatusCode: Int, Error {
    ...
    /// - Error Code for Activity Tracker
    case noStatusSelected = 452
    case todoStatusNotSelected = 453
    case doneNotSelected = 454
    case statusDoseNotExist = 455
    case seletedStatusUnique = 456
    case ownerOnlyCanDeleteBoard = 457
    case ownerOnlyCanEditBoard = 458
    case boardNotFound = 459
    case assignedUserNotExist = 460
    case labelNotExist = 461
    case justTwoLabelsAllowed = 462
    case cantAssignAnotherUserTaskToPrivateBoard = 463
    case templateDoseNotExist = 464
    case taskDoseNotExist = 465
    case statusDicNotConfigure = 512
